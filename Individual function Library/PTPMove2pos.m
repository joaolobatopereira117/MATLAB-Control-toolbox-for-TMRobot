...
function [check,move]=PTPMove2pos(client,pose,velperc)
    ...
    data=['1,PTP("CPP",' num2str(pose(1)) ',' num2str(pose(2)) ',' num2str(pose(3)) ',' ...
    num2str(pose(4)) ',' num2str(pose(5)) ',' num2str(pose(6)) ',' num2str(velperc) ...
    ',100,0,false)' char(13) newline 'QueueTag(1)'];
